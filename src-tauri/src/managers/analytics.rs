...
const STOPWORDS: &[&str] = &[
    ...
    "had", "not", "but", "all", "can", "her", "his", "him", "she", "they", "them", "their", "our",
    "out", "who", "get", "got", "how", "why", "what", "when", "where", "which", "would", "could",
    "should", "will", "just", "like", "into", "than", "then", "there", "here", "some", "such",
    "only", "over", "also", "back", "even", "very", "much", "more", "most", "other", "any", "each",
    "from", "about", "after", "before", "because", "been", "being", "does", "did", "doing", "done",
    "its", "itself", "him", "himself", "herself", "myself", "yourself", "ourselves", "themselves",
    "one", "two", "three", "off", "onto", "upon", "yes", "yeah", "okay", "well", "gonna", "wanna",
    "kind", "sort", "really", "actually", "basically", "literally", "maybe", "probably", "going",
    "want", "know", "think", "thing", "things", "make", "made", "need", "use", "used", "using",
    "let", "lets", "put", "way", "now", "new", "see", "say", "said", "and", "for", "are", "not",
    "with", "you", "the",
];
