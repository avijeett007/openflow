//! Model capability probing — the seam between OpenFlow's model UI and "what can
...
/// How confident we are that OpenFlow can run a given model, judged from its GGUF
